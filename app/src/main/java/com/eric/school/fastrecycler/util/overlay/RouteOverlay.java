package com.eric.school.fastrecycler.util.overlay;
...
import com.eric.school.fastrecycler.MapActivity;
...
public class RouteOverlay {
    ...
    protected BitmapDescriptor getStartBitmapDescriptor() {
        View markerView = LayoutInflater.from(mContext).inflate(R.layout.view_recycler_place_marker, null, false);
